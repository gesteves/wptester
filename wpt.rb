...
class WPT
  ...
  def request_test
    if active_test? && !test_complete?
      ...
      url = "http://www.webpagetest.org/runtest.php?url=#{@url}&location=#{ENV['WPT_LOCATION']}&k=#{@key}&f=json&runs=#{ENV['WPT_RUNS']}&fvonly=1&browser_width=1280&browser_height=800&medianMetric=SpeedIndex"
